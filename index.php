...
<!-- <nav class="navbar">
    ...
    <div class="nav-inner">
        ...
        <a href="/smart-transit/index.php" class="logo">
...
<a href="<?= BASE_URL ?>/register.php">Get Started</a>
    ...
    <div class="container hero-content">
        ...
        <div class="hero-text">
            ...
            <div class="hero-buttons">
                ...
                <a
                    href="<?= BASE_URL ?>/passenger/routes.php"
...
>
    ...
    <div class="container">
        ...
        <div class="service-grid">
            ...
            <a
                href="<?= BASE_URL ?>/passenger/buses.php"
                class="service-card"
            >
            ...
            <a
                href="<?= BASE_URL ?>/passenger/schedules.php"
                class="service-card"
            >
            ...
            <a
                href="<?= BASE_URL ?>/passenger/notices.php"
                class="service-card"
            >
    ...
    <div class="container network-grid">
        ...
        <div class="network-card">
            ...
            <div class="network-footer">
                ...
                <a href="<?= BASE_URL ?>/passenger/routes.php">
                    View all →
                </a>
